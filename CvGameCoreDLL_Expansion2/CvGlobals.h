...
//Weight for City Target if Liberation Quest Active
	...
	inline int getOPINION_WEIGHT_POLICY_FIERCE()
	{
		return m_iOPINION_WEIGHT_POLICY_FIERCE;
	}
	inline int getOPINION_WEIGHT_POLICY_STRONG()
	{
		return m_iOPINION_WEIGHT_POLICY_STRONG;
	}
	inline int getOPINION_WEIGHT_POLICY_WEAK()
	{
		return m_iOPINION_WEIGHT_POLICY_WEAK;
	}
	inline int getOPINION_WEIGHT_POLICY_NONE()
	{
		return m_iOPINION_WEIGHT_POLICY_NONE;
	}
	...
	inline int getOPINION_WEIGHT_DIPLOMAT()
	{
		return m_iOPINION_WEIGHT_DIPLOMAT;
	}
	inline int getOPINION_WEIGHT_DIPLOMAT_MOD()
	{
		return m_iOPINION_WEIGHT_DIPLOMAT_MOD;
	}
	inline int getOPINION_WEIGHT_DIPLOMAT_CAPITULATED_VASSAL()
	{
		return m_iOPINION_WEIGHT_DIPLOMAT_CAPITULATED_VASSAL;
	}
	...
	inline int getOPINION_WEIGHT_LIBERATED_CAPITAL_VASSAL_MULTIPLIER()
	{
		return m_iOPINION_WEIGHT_LIBERATED_CAPITAL_VASSAL_MULTIPLIER;
	}
	inline int getOPINION_WEIGHT_LIBERATED_HOLY_CITY()
	{
		return m_iOPINION_WEIGHT_LIBERATED_HOLY_CITY;
	}
	inline int getOPINION_WEIGHT_LIBERATED_HOLY_CITY_VASSAL_MULTIPLIER()
	{
		return m_iOPINION_WEIGHT_LIBERATED_HOLY_CITY_VASSAL_MULTIPLIER;
	}
	inline int getOPINION_WEIGHT_LIBERATED_CITY()
	{
		return m_iOPINION_WEIGHT_LIBERATED_CITY;
	}
	inline int getOPINION_WEIGHT_LIBERATED_CITY_VASSAL_MULTIPLIER()
	{
		return m_iOPINION_WEIGHT_LIBERATED_CITY_VASSAL_MULTIPLIER;
	}
	inline int getOPINION_WEIGHT_RETURNED_CAPITAL()
	{
		return m_iOPINION_WEIGHT_RETURNED_CAPITAL;
	}
	inline int getOPINION_WEIGHT_RETURNED_CAPITAL_VASSAL_MULTIPLIER()
	{
		return m_iOPINION_WEIGHT_RETURNED_CAPITAL_VASSAL_MULTIPLIER;
	}
	inline int getOPINION_WEIGHT_RETURNED_HOLY_CITY()
	{
		return m_iOPINION_WEIGHT_RETURNED_HOLY_CITY;
	}
	inline int getOPINION_WEIGHT_RETURNED_HOLY_CITY_VASSAL_MULTIPLIER()
	{
		return m_iOPINION_WEIGHT_RETURNED_HOLY_CITY_VASSAL_MULTIPLIER;
	}
	...
	inline int getPOLICY_SCORE_NEEDY_BONUS()
	{
		return m_iPOLICY_SCORE_NEEDY_BONUS;
	}
	...
	inline int getOPINION_WEIGHT_WE_LIKED_THEIR_PROPOSAL_STRONG()
	{
		return m_iOPINION_WEIGHT_WE_LIKED_THEIR_PROPOSAL_STRONG;
	}
	inline int getOPINION_WEIGHT_WE_LIKED_THEIR_PROPOSAL_OVERWHELMING()
	{
		return m_iOPINION_WEIGHT_WE_LIKED_THEIR_PROPOSAL_OVERWHELMING;
	}
	inline int getOPINION_WEIGHT_WE_LIKED_THEIR_PROPOSAL_DIPLOMAT_MULTIPLIER()
	{
		return m_iOPINION_WEIGHT_WE_LIKED_THEIR_PROPOSAL_DIPLOMAT_MULTIPLIER;
	}
	...
	inline int getOPINION_WEIGHT_WE_DISLIKED_THEIR_PROPOSAL_STRONG()
	{
		return m_iOPINION_WEIGHT_WE_DISLIKED_THEIR_PROPOSAL_STRONG;
	}
	inline int getOPINION_WEIGHT_WE_DISLIKED_THEIR_PROPOSAL_OVERWHELMING()
	{
		return m_iOPINION_WEIGHT_WE_DISLIKED_THEIR_PROPOSAL_OVERWHELMING;
	}
	inline int getOPINION_WEIGHT_WE_DISLIKED_THEIR_PROPOSAL_DIPLOMAT_MULTIPLIER()
	{
		return m_iOPINION_WEIGHT_WE_DISLIKED_THEIR_PROPOSAL_DIPLOMAT_MULTIPLIER;
	}
	...
	inline int getOPINION_WEIGHT_THEY_SUPPORTED_OUR_PROPOSAL_MIN()
	{
		return m_iOPINION_WEIGHT_THEY_SUPPORTED_OUR_PROPOSAL_MIN;
	}
	inline int getOPINION_WEIGHT_THEY_SUPPORTED_OUR_PROPOSAL_MAX()
	{
		return m_iOPINION_WEIGHT_THEY_SUPPORTED_OUR_PROPOSAL_MAX;
	}
	inline int getOPINION_WEIGHT_THEY_SUPPORTED_OUR_PROPOSAL_DIPLOMAT_MULTIPLIER()
	{
		return m_iOPINION_WEIGHT_THEY_SUPPORTED_OUR_PROPOSAL_DIPLOMAT_MULTIPLIER;
	}
	...
	inline int getOPINION_WEIGHT_THEY_FOILED_OUR_PROPOSAL_MIN()
	{
		return m_iOPINION_WEIGHT_THEY_FOILED_OUR_PROPOSAL_MIN;
	}
	inline int getOPINION_WEIGHT_THEY_FOILED_OUR_PROPOSAL_MAX()
	{
		return m_iOPINION_WEIGHT_THEY_FOILED_OUR_PROPOSAL_MAX;
	}
	inline int getOPINION_WEIGHT_THEY_FOILED_OUR_PROPOSAL_DIPLOMAT_MULTIPLIER()
	{
		return m_iOPINION_WEIGHT_THEY_FOILED_OUR_PROPOSAL_DIPLOMAT_MULTIPLIER;
	}
	...
	inline int getOPINION_WEIGHT_THEY_SUPPORTED_OUR_HOSTING_MIN()
	{
		return m_iOPINION_WEIGHT_THEY_SUPPORTED_OUR_HOSTING_MIN;
	}
	inline int getOPINION_WEIGHT_THEY_SUPPORTED_OUR_HOSTING_MAX()
	{
		return m_iOPINION_WEIGHT_THEY_SUPPORTED_OUR_HOSTING_MAX;
	}
	inline int getOPINION_WEIGHT_THEY_SUPPORTED_OUR_HOSTING_DIPLOMAT_MULTIPLIER()
	{
		return m_iOPINION_WEIGHT_THEY_SUPPORTED_OUR_HOSTING_DIPLOMAT_MULTIPLIER;
	}
	...
	inline int getOPINION_WEIGHT_PER_VOTE_PERCENT()
	{
		return m_iOPINION_WEIGHT_PER_VOTE_PERCENT;
	}
	...
	inline int getNORMAL_WAR_MULTIPLIER_TARGET_SOFT()
	{
		return m_iNORMAL_WAR_MULTIPLIER_TARGET_SOFT;
	}
	inline int getNORMAL_WAR_MULTIPLIER_TARGET_FAVORABLE()
	{
		return m_iNORMAL_WAR_MULTIPLIER_TARGET_FAVORABLE;
	}
	inline int getNORMAL_WAR_MULTIPLIER_TARGET_AVERAGE()
	{
		return m_iNORMAL_WAR_MULTIPLIER_TARGET_AVERAGE;
	}
	inline int getNORMAL_WAR_MULTIPLIER_TARGET_BAD()
	{
		return m_iNORMAL_WAR_MULTIPLIER_TARGET_BAD;
	}
	inline int getNORMAL_WAR_MULTIPLIER_TARGET_IMPOSSIBLE()
	{
		return m_iNORMAL_WAR_MULTIPLIER_TARGET_IMPOSSIBLE;
	}
	inline int getCONQUEST_WAR_MULTIPLIER_TARGET_SOFT()
	{
		return m_iCONQUEST_WAR_MULTIPLIER_TARGET_SOFT;
	}
	inline int getCONQUEST_WAR_MULTIPLIER_TARGET_FAVORABLE()
	{
		return m_iCONQUEST_WAR_MULTIPLIER_TARGET_FAVORABLE;
	}
	inline int getCONQUEST_WAR_MULTIPLIER_TARGET_AVERAGE()
	{
		return m_iCONQUEST_WAR_MULTIPLIER_TARGET_AVERAGE;
	}
	inline int getCONQUEST_WAR_MULTIPLIER_TARGET_BAD()
	{
		return m_iCONQUEST_WAR_MULTIPLIER_TARGET_BAD;
	}
	inline int getCONQUEST_WAR_MULTIPLIER_TARGET_IMPOSSIBLE()
	{
		return m_iCONQUEST_WAR_MULTIPLIER_TARGET_IMPOSSIBLE;
	}
	...
	inline int getCOOP_WAR_DESIRE_THRESHOLD()
	{
		return m_iCOOP_WAR_DESIRE_THRESHOLD;
	}
	...
	inline int getTARGET_MAJOR_BACKUP_PATHETIC()
	{
		return m_iTARGET_MAJOR_BACKUP_PATHETIC;
	}
	inline int getTARGET_MAJOR_BACKUP_WEAK()
	{
		return m_iTARGET_MAJOR_BACKUP_WEAK;
	}
	inline int getTARGET_MAJOR_BACKUP_POOR()
	{
		return m_iTARGET_MAJOR_BACKUP_POOR;
	}
	inline int getTARGET_MAJOR_BACKUP_AVERAGE()
	{
		return m_iTARGET_MAJOR_BACKUP_AVERAGE;
	}
	inline int getTARGET_MAJOR_BACKUP_STRONG()
	{
		return m_iTARGET_MAJOR_BACKUP_STRONG;
	}
	inline int getTARGET_MAJOR_BACKUP_POWERFUL()
	{
		return m_iTARGET_MAJOR_BACKUP_POWERFUL;
	}
	inline int getTARGET_MAJOR_BACKUP_IMMENSE()
	{
		return m_iTARGET_MAJOR_BACKUP_IMMENSE;
	}
	inline int getTARGET_MAJOR_BACKUP_DISTANT()
	{
		return m_iTARGET_MAJOR_BACKUP_DISTANT;
	}
	inline int getTARGET_MAJOR_BACKUP_FAR()
	{
		return m_iTARGET_MAJOR_BACKUP_FAR;
	}
	inline int getTARGET_MAJOR_BACKUP_CLOSE()
	{
		return m_iTARGET_MAJOR_BACKUP_CLOSE;
	}
	inline int getTARGET_MAJOR_BACKUP_NEIGHBORS()
	{
		return m_iTARGET_MAJOR_BACKUP_NEIGHBORS;
	}
	...
	inline int getVICTORY_BLOCK_FIERCE_THRESHOLD()
	{
		return m_iVICTORY_BLOCK_FIERCE_THRESHOLD;
	}
	inline int getVICTORY_BLOCK_STRONG_THRESHOLD()
	{
		return m_iVICTORY_BLOCK_STRONG_THRESHOLD;
	}
	inline int getVICTORY_BLOCK_WEAK_THRESHOLD()
	{
		return m_iVICTORY_BLOCK_WEAK_THRESHOLD;
	}
	inline int getTECH_BLOCK_FIERCE_THRESHOLD()
	{
		return m_iTECH_BLOCK_FIERCE_THRESHOLD;
	}
	inline int getTECH_BLOCK_STRONG_THRESHOLD()
	{
		return m_iTECH_BLOCK_STRONG_THRESHOLD;
	}
	inline int getTECH_BLOCK_WEAK_THRESHOLD()
	{
		return m_iTECH_BLOCK_WEAK_THRESHOLD;
	}
	inline int getPOLICY_BLOCK_FIERCE_THRESHOLD()
	{
		return m_iPOLICY_BLOCK_FIERCE_THRESHOLD;
	}
	inline int getPOLICY_BLOCK_STRONG_THRESHOLD()
	{
		return m_iPOLICY_BLOCK_STRONG_THRESHOLD;
	}
	inline int getPOLICY_BLOCK_WEAK_THRESHOLD()
	{
		return m_iPOLICY_BLOCK_WEAK_THRESHOLD;
	}
	...
	inline int getVICTORY_BLOCK_GRAND_STRATEGY_DIFFERENCE_POSITIVE()
	{
		return m_iVICTORY_BLOCK_GRAND_STRATEGY_DIFFERENCE_POSITIVE;
	}
	inline int getVICTORY_BLOCK_GRAND_STRATEGY_DIFFERENCE_LIKELY()
	{
		return m_iVICTORY_BLOCK_GRAND_STRATEGY_DIFFERENCE_LIKELY;
	}
	inline int getVICTORY_BLOCK_GRAND_STRATEGY_DIFFERENCE_UNSURE()
	{
		return m_iVICTORY_BLOCK_GRAND_STRATEGY_DIFFERENCE_UNSURE;
	}
	...
	inline int getDOF_TURN_BUFFER_REDUCTION_PER_ERA()
	{
		return m_iDOF_TURN_BUFFER_REDUCTION_PER_ERA;
	}
	inline int getJUST_MET_TURN_BUFFER()
	{
		return m_iJUST_MET_TURN_BUFFER;
	}
	...
	inline int getMILITARY_PROMISE_IGNORED_TURNS_UNTIL_FORGIVEN()
	{
		return m_iMILITARY_PROMISE_IGNORED_TURNS_UNTIL_FORGIVEN;
	}
	inline int getMILITARY_PROMISE_BROKEN_TURNS_UNTIL_FORGIVEN()
	{
		return m_iMILITARY_PROMISE_BROKEN_TURNS_UNTIL_FORGIVEN;
	}
	...
	inline int getEXPANSION_PROMISE_IGNORED_TURNS_UNTIL_FORGIVEN()
	{
		return m_iEXPANSION_PROMISE_IGNORED_TURNS_UNTIL_FORGIVEN;
	}
	inline int getEXPANSION_PROMISE_BROKEN_TURNS_UNTIL_FORGIVEN()
	{
		return m_iEXPANSION_PROMISE_BROKEN_TURNS_UNTIL_FORGIVEN;
	}
	inline int getBORDER_PROMISE_TURNS_EFFECTIVE()
	{
		return m_iBORDER_PROMISE_TURNS_EFFECTIVE;
	}
	inline int getBORDER_PROMISE_IGNORED_TURNS_UNTIL_FORGIVEN()
	{
		return m_iBORDER_PROMISE_IGNORED_TURNS_UNTIL_FORGIVEN;
	}
	inline int getBORDER_PROMISE_BROKEN_TURNS_UNTIL_FORGIVEN()
	{
		return m_iBORDER_PROMISE_BROKEN_TURNS_UNTIL_FORGIVEN;
	}
	inline int getBULLY_CS_PROMISE_IGNORED_TURNS_UNTIL_FORGIVEN()
	{
		return m_iBULLY_CS_PROMISE_IGNORED_TURNS_UNTIL_FORGIVEN;
	}
	inline int getBULLY_CS_PROMISE_BROKEN_TURNS_UNTIL_FORGIVEN()
	{
		return m_iBULLY_CS_PROMISE_BROKEN_TURNS_UNTIL_FORGIVEN;
	}
	inline int getATTACK_CS_PROMISE_IGNORED_TURNS_UNTIL_FORGIVEN()
	{
		return m_iATTACK_CS_PROMISE_IGNORED_TURNS_UNTIL_FORGIVEN;
	}
	inline int getATTACK_CS_PROMISE_BROKEN_TURNS_UNTIL_FORGIVEN()
	{
		return m_iATTACK_CS_PROMISE_BROKEN_TURNS_UNTIL_FORGIVEN;
	}
	inline int getSPY_PROMISE_IGNORED_TURNS_UNTIL_FORGIVEN()
	{
		return m_iSPY_PROMISE_IGNORED_TURNS_UNTIL_FORGIVEN;
	}
	inline int getSPY_PROMISE_BROKEN_TURNS_UNTIL_FORGIVEN()
	{
		return m_iSPY_PROMISE_BROKEN_TURNS_UNTIL_FORGIVEN;
	}
	inline int getCONVERT_PROMISE_IGNORED_TURNS_UNTIL_FORGIVEN()
	{
		return m_iCONVERT_PROMISE_IGNORED_TURNS_UNTIL_FORGIVEN;
	}
	inline int getCONVERT_PROMISE_BROKEN_TURNS_UNTIL_FORGIVEN()
	{
		return m_iCONVERT_PROMISE_BROKEN_TURNS_UNTIL_FORGIVEN;
	}
	inline int getDIGGING_PROMISE_IGNORED_TURNS_UNTIL_FORGIVEN()
	{
		return m_iDIGGING_PROMISE_IGNORED_TURNS_UNTIL_FORGIVEN;
	}
	inline int getDIGGING_PROMISE_BROKEN_TURNS_UNTIL_FORGIVEN()
	{
		return m_iDIGGING_PROMISE_BROKEN_TURNS_UNTIL_FORGIVEN;
	}
	inline int getCOOP_WAR_PROMISE_BROKEN_TURNS_UNTIL_FORGIVEN()
	{
		return m_iCOOP_WAR_PROMISE_BROKEN_TURNS_UNTIL_FORGIVEN;
	}

	inline int getDOF_BROKEN_TURNS_UNTIL_FORGIVEN()
	{
		return m_iDOF_BROKEN_TURNS_UNTIL_FORGIVEN;
	}
	inline int getDOF_BROKEN_TURNS_UNTIL_FORGIVEN_FRIENDS()
	{
		return m_iDOF_BROKEN_TURNS_UNTIL_FORGIVEN_FRIENDS;
	}
	inline int getFRIEND_DENOUNCED_US_TURNS_UNTIL_FORGIVEN()
	{
		return m_iFRIEND_DENOUNCED_US_TURNS_UNTIL_FORGIVEN;
	}
	inline int getFRIEND_DECLARED_WAR_ON_US_TURNS_UNTIL_FORGIVEN()
	{
		return m_iFRIEND_DECLARED_WAR_ON_US_TURNS_UNTIL_FORGIVEN;
	}
	inline int getMASTER_DECLARED_WAR_ON_US_TURNS_UNTIL_FORGIVEN()
	{
		return m_iMASTER_DECLARED_WAR_ON_US_TURNS_UNTIL_FORGIVEN;
	}
	inline int getDOF_BROKEN_BACKSTAB_TIMER()
	{
		return m_iDOF_BROKEN_BACKSTAB_TIMER;
	}
	...
	inline int getBALANCE_WAR_WEARINESS_POPULATION_CAP()
	{
		return m_iBALANCE_WAR_WEARINESS_POPULATION_CAP;
	}
	...
	inline int getPILLAGED_TILE_BASE_WAR_VALUE()
	{
		return m_iPILLAGED_TILE_BASE_WAR_VALUE;
	}
	inline int getSTOLEN_TILE_BASE_WAR_VALUE()
	{
		return m_iSTOLEN_TILE_BASE_WAR_VALUE;
	}
	...
	GD_INT_DEF(DIPLOAI_DISABLE_VICTORY_COMPETITION)
	GD_INT_DEF(DIPLOAI_DISABLE_ENDGAME_AGGRESSION)
	GD_INT_DEF(DIPLOAI_ENABLE_NUCLEAR_GANDHI)
	GD_INT_DEF(DIPLOAI_DISABLE_WAR_BRIBES)
	GD_INT_DEF(DIPLOAI_DISABLE_CITY_TRADING)
	GD_INT_DEF(DIPLOAI_DISABLE_INSULT_MESSAGES)
	GD_INT_DEF(DIPLOAI_DISABLE_COMPLIMENT_MESSAGES)
	GD_INT_DEF(DIPLOAI_SHOW_ALL_OPINION_MODIFIERS)
	GD_INT_DEF(DIPLOAI_SHOW_ALL_OPINION_VALUES)
	GD_INT_DEF(DIPLOAI_SHOW_BASE_HUMAN_OPINION)
	GD_INT_DEF(DIPLOAI_DISABLE_FRIENDSHIP_REQUESTS)
	GD_INT_DEF(DIPLOAI_DISABLE_GIFT_OFFERS)
	GD_INT_DEF(DIPLOAI_DISABLE_COOP_WAR_REQUESTS)
	GD_INT_DEF(DIPLOAI_DISABLE_HELP_REQUESTS)
	GD_INT_DEF(DIPLOAI_DISABLE_TRADE_OFFERS)
	GD_INT_DEF(DIPLOAI_DISABLE_PEACE_OFFERS)
	GD_INT_DEF(DIPLOAI_DISABLE_ALL_STATEMENTS)
	GD_INT_DEF(DIPLOAI_PASSIVE_MODE)
	GD_INT_DEF(DIPLOAI_AGGRESSIVE_MODE)
	GD_INT_DEF(DIPLOAI_DISABLE_DOMINATION_ONLY_AGGRESSION)
	GD_INT_DEF(DIPLOAI_ENABLE_DEBUG_MODE)
...
protected:
	...
	************************************************************************************************************************/
	...
	int m_iOPINION_WEIGHT_POLICY_FIERCE;
	int m_iOPINION_WEIGHT_POLICY_STRONG;
	int m_iOPINION_WEIGHT_POLICY_WEAK;
	int m_iOPINION_WEIGHT_POLICY_NONE;
	...
	int m_iOPINION_WEIGHT_DIPLOMAT;
	int m_iOPINION_WEIGHT_DIPLOMAT_MOD;
	int m_iOPINION_WEIGHT_DIPLOMAT_CAPITULATED_VASSAL;
	...
	int m_iOPINION_WEIGHT_LIBERATED_CAPITAL_VASSAL_MULTIPLIER;
	int m_iOPINION_WEIGHT_LIBERATED_HOLY_CITY;
	int m_iOPINION_WEIGHT_LIBERATED_HOLY_CITY_VASSAL_MULTIPLIER;
	int m_iOPINION_WEIGHT_LIBERATED_CITY;
	int m_iOPINION_WEIGHT_LIBERATED_CITY_VASSAL_MULTIPLIER;
	int m_iOPINION_WEIGHT_RETURNED_CAPITAL;
	int m_iOPINION_WEIGHT_RETURNED_CAPITAL_VASSAL_MULTIPLIER;
	int m_iOPINION_WEIGHT_RETURNED_HOLY_CITY;
	int m_iOPINION_WEIGHT_RETURNED_HOLY_CITY_VASSAL_MULTIPLIER;
	...
	int m_iPOLICY_SCORE_NEEDY_BONUS;
	...
	int m_iOPINION_WEIGHT_WE_LIKED_THEIR_PROPOSAL_STRONG;
	int m_iOPINION_WEIGHT_WE_LIKED_THEIR_PROPOSAL_OVERWHELMING;
	int m_iOPINION_WEIGHT_WE_LIKED_THEIR_PROPOSAL_DIPLOMAT_MULTIPLIER;
	int m_iOPINION_WEIGHT_WE_LIKED_THEIR_PROPOSAL_NUM_TURNS;
	int m_iOPINION_WEIGHT_WE_DISLIKED_THEIR_PROPOSAL;
	int m_iOPINION_WEIGHT_WE_DISLIKED_THEIR_PROPOSAL_STRONG;
	int m_iOPINION_WEIGHT_WE_DISLIKED_THEIR_PROPOSAL_OVERWHELMING;
	int m_iOPINION_WEIGHT_WE_DISLIKED_THEIR_PROPOSAL_DIPLOMAT_MULTIPLIER;
	int m_iOPINION_WEIGHT_WE_DISLIKED_THEIR_PROPOSAL_NUM_TURNS;
	int m_iOPINION_WEIGHT_THEY_SUPPORTED_OUR_PROPOSAL;
	int m_iOPINION_WEIGHT_THEY_SUPPORTED_OUR_PROPOSAL_MIN;
	int m_iOPINION_WEIGHT_THEY_SUPPORTED_OUR_PROPOSAL_MAX;
	int m_iOPINION_WEIGHT_THEY_SUPPORTED_OUR_PROPOSAL_DIPLOMAT_MULTIPLIER;
	int m_iOPINION_WEIGHT_THEY_SUPPORTED_OUR_PROPOSAL_NUM_TURNS;
	int m_iOPINION_WEIGHT_THEY_FOILED_OUR_PROPOSAL;
	int m_iOPINION_WEIGHT_THEY_FOILED_OUR_PROPOSAL_MIN;
	int m_iOPINION_WEIGHT_THEY_FOILED_OUR_PROPOSAL_MAX;
	int m_iOPINION_WEIGHT_THEY_FOILED_OUR_PROPOSAL_DIPLOMAT_MULTIPLIER;
	int m_iOPINION_WEIGHT_THEY_FOILED_OUR_PROPOSAL_NUM_TURNS;
	int m_iOPINION_WEIGHT_THEY_SUPPORTED_OUR_HOSTING;
	int m_iOPINION_WEIGHT_THEY_SUPPORTED_OUR_HOSTING_MIN;
	int m_iOPINION_WEIGHT_THEY_SUPPORTED_OUR_HOSTING_MAX;
	int m_iOPINION_WEIGHT_THEY_SUPPORTED_OUR_HOSTING_DIPLOMAT_MULTIPLIER;
	int m_iOPINION_WEIGHT_THEY_SUPPORTED_OUR_HOSTING_NUM_TURNS;
	int m_iOPINION_WEIGHT_PER_VOTE_PERCENT;
	...
	int m_iNORMAL_WAR_MULTIPLIER_TARGET_SOFT;
	int m_iNORMAL_WAR_MULTIPLIER_TARGET_FAVORABLE;
	int m_iNORMAL_WAR_MULTIPLIER_TARGET_AVERAGE;
	int m_iNORMAL_WAR_MULTIPLIER_TARGET_BAD;
	int m_iNORMAL_WAR_MULTIPLIER_TARGET_IMPOSSIBLE;
	int m_iCONQUEST_WAR_MULTIPLIER_TARGET_SOFT;
	int m_iCONQUEST_WAR_MULTIPLIER_TARGET_FAVORABLE;
	int m_iCONQUEST_WAR_MULTIPLIER_TARGET_AVERAGE;
	int m_iCONQUEST_WAR_MULTIPLIER_TARGET_BAD;
	int m_iCONQUEST_WAR_MULTIPLIER_TARGET_IMPOSSIBLE;
	...
	int m_iCOOP_WAR_DESIRE_THRESHOLD;
	...
	int m_iTARGET_MAJOR_BACKUP_PATHETIC;
	int m_iTARGET_MAJOR_BACKUP_WEAK;
	int m_iTARGET_MAJOR_BACKUP_POOR;
	int m_iTARGET_MAJOR_BACKUP_AVERAGE;
	int m_iTARGET_MAJOR_BACKUP_STRONG;
	int m_iTARGET_MAJOR_BACKUP_POWERFUL;
	int m_iTARGET_MAJOR_BACKUP_IMMENSE;
	int m_iTARGET_MAJOR_BACKUP_DISTANT;
	int m_iTARGET_MAJOR_BACKUP_FAR;
	int m_iTARGET_MAJOR_BACKUP_CLOSE;
	int m_iTARGET_MAJOR_BACKUP_NEIGHBORS;
	...
	int m_iVICTORY_BLOCK_FIERCE_THRESHOLD;
	int m_iVICTORY_BLOCK_STRONG_THRESHOLD;
	int m_iVICTORY_BLOCK_WEAK_THRESHOLD;
	int m_iTECH_BLOCK_FIERCE_THRESHOLD;
	int m_iTECH_BLOCK_STRONG_THRESHOLD;
	int m_iTECH_BLOCK_WEAK_THRESHOLD;
	int m_iPOLICY_BLOCK_FIERCE_THRESHOLD;
	int m_iPOLICY_BLOCK_STRONG_THRESHOLD;
	int m_iPOLICY_BLOCK_WEAK_THRESHOLD;
	...
	int m_iVICTORY_BLOCK_GRAND_STRATEGY_DIFFERENCE_POSITIVE;
	int m_iVICTORY_BLOCK_GRAND_STRATEGY_DIFFERENCE_LIKELY;
	int m_iVICTORY_BLOCK_GRAND_STRATEGY_DIFFERENCE_UNSURE;
	...
	int m_iDOF_TURN_BUFFER_REDUCTION_PER_ERA;
	int m_iJUST_MET_TURN_BUFFER;
	...
	int m_iMILITARY_PROMISE_IGNORED_TURNS_UNTIL_FORGIVEN;
	int m_iMILITARY_PROMISE_BROKEN_TURNS_UNTIL_FORGIVEN;
	int m_iEXPANSION_BICKER_TIMEOUT;
	int m_iEXPANSION_PROMISE_TURNS_EFFECTIVE;
	int m_iEXPANSION_PROMISE_IGNORED_TURNS_UNTIL_FORGIVEN;
	int m_iEXPANSION_PROMISE_BROKEN_TURNS_UNTIL_FORGIVEN;
	int m_iBORDER_PROMISE_TURNS_EFFECTIVE;
	int m_iBORDER_PROMISE_IGNORED_TURNS_UNTIL_FORGIVEN;
	int m_iBORDER_PROMISE_BROKEN_TURNS_UNTIL_FORGIVEN;
	int m_iBULLY_CS_PROMISE_IGNORED_TURNS_UNTIL_FORGIVEN;
	int m_iBULLY_CS_PROMISE_BROKEN_TURNS_UNTIL_FORGIVEN;
	int m_iATTACK_CS_PROMISE_IGNORED_TURNS_UNTIL_FORGIVEN;
	int m_iATTACK_CS_PROMISE_BROKEN_TURNS_UNTIL_FORGIVEN;
	int m_iSPY_PROMISE_IGNORED_TURNS_UNTIL_FORGIVEN;
	int m_iSPY_PROMISE_BROKEN_TURNS_UNTIL_FORGIVEN;
	int m_iCONVERT_PROMISE_IGNORED_TURNS_UNTIL_FORGIVEN;
	int m_iCONVERT_PROMISE_BROKEN_TURNS_UNTIL_FORGIVEN;
	int m_iDIGGING_PROMISE_IGNORED_TURNS_UNTIL_FORGIVEN;
	int m_iDIGGING_PROMISE_BROKEN_TURNS_UNTIL_FORGIVEN;
	int m_iCOOP_WAR_PROMISE_BROKEN_TURNS_UNTIL_FORGIVEN;

	int m_iDOF_BROKEN_TURNS_UNTIL_FORGIVEN;
	int m_iDOF_BROKEN_TURNS_UNTIL_FORGIVEN_FRIENDS;
	int m_iFRIEND_DENOUNCED_US_TURNS_UNTIL_FORGIVEN;
	int m_iFRIEND_DECLARED_WAR_ON_US_TURNS_UNTIL_FORGIVEN;
	int m_iMASTER_DECLARED_WAR_ON_US_TURNS_UNTIL_FORGIVEN;
	int m_iDOF_BROKEN_BACKSTAB_TIMER;
	...
	int m_iBALANCE_WAR_WEARINESS_POPULATION_CAP;
	...
	int m_iPILLAGED_TILE_BASE_WAR_VALUE;
	int m_iSTOLEN_TILE_BASE_WAR_VALUE;
	...
	GD_INT_DECL(DIPLOAI_DISABLE_VICTORY_COMPETITION);
	GD_INT_DECL(DIPLOAI_DISABLE_ENDGAME_AGGRESSION);
	GD_INT_DECL(DIPLOAI_ENABLE_NUCLEAR_GANDHI);
	GD_INT_DECL(DIPLOAI_DISABLE_WAR_BRIBES);
	GD_INT_DECL(DIPLOAI_DISABLE_CITY_TRADING);
	GD_INT_DECL(DIPLOAI_DISABLE_INSULT_MESSAGES);
	GD_INT_DECL(DIPLOAI_DISABLE_COMPLIMENT_MESSAGES);
	GD_INT_DECL(DIPLOAI_SHOW_ALL_OPINION_MODIFIERS);
	GD_INT_DECL(DIPLOAI_SHOW_ALL_OPINION_VALUES);
	GD_INT_DECL(DIPLOAI_SHOW_BASE_HUMAN_OPINION);
	GD_INT_DECL(DIPLOAI_DISABLE_FRIENDSHIP_REQUESTS);
	GD_INT_DECL(DIPLOAI_DISABLE_GIFT_OFFERS);
	GD_INT_DECL(DIPLOAI_DISABLE_COOP_WAR_REQUESTS);
	GD_INT_DECL(DIPLOAI_DISABLE_HELP_REQUESTS);
	GD_INT_DECL(DIPLOAI_DISABLE_TRADE_OFFERS);
	GD_INT_DECL(DIPLOAI_DISABLE_PEACE_OFFERS);
	GD_INT_DECL(DIPLOAI_DISABLE_ALL_STATEMENTS);
	GD_INT_DECL(DIPLOAI_PASSIVE_MODE);
	GD_INT_DECL(DIPLOAI_AGGRESSIVE_MODE);
	GD_INT_DECL(DIPLOAI_DISABLE_DOMINATION_ONLY_AGGRESSION);
	GD_INT_DECL(DIPLOAI_ENABLE_DEBUG_MODE);
